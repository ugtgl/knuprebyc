...
public class Elevator : MonoBehaviour
{
    ...
    void Update()
    {
        if (collided && scrollManager.ScrollsCollected) // eğer asansöre binilmişse ve scrollar toplanmış ise
        {
            ...
            else if((Input.GetKey(KeyCode.E)) && (speed > -maxSpeed)) //yukarıdakinin biraz farklısı, burada anlık hız maksimum hızdan fazla ise
            {
                if (speed < 1)
                {
